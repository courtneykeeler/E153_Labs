...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, keepaspectratio=true]{lab4/3-4_scope.png}
...
%Experimental try 2:
%C = 11.4 uF, R = 2.150k, delta t = 6.028 ms, Vr = 4.084 V, Vm = 18.6 V
%C = 4.7 uF, R = 2.150K, delta t = 5.290 ms, Vr = 7.621 V, Vm = 18.6 V
%C = 22.3 uF, R = 2.150k, delta t = 6.582 ms, Vr = 2.400 V, Vm = 18.6 V

%Calculated using delta t
%C = 11.78
%C = 4.67
%C = 22.16

%The back-calculated capacitor value is extremely sensitive to the Vr measurement and not very sensistive to the delta t measurement
